...
void pleasant_opcontrol()
{
  ...
  main_controller.ButtonL2.pressed([](){flapup_solenoid.set(false);}); //Single Shoot
  
  main_controller.ButtonL1.pressed([](){flapup_solenoid.set(true);});
...
CommandController prog_skills_loader_side()
{
  ...
  lss.add({
      ...
      (new FunctionCommand([](){drive_sys.drive_tank(roller_power, roller_power);return false;}))->withTimeout(0.65),
      (new FunctionCommand([](){drive_sys.drive_tank(0, 0);return true;})),
      (new OdomSetPosition(odometry_sys, {.x = 32.0, .y = 4.16, .rot = -90})),
      (new FunctionCommand([](){drive_sys.drive_tank(-roller_power, -roller_power);return false;}))->withTimeout(0.25),
  ...
  lss.add({
      ...
      (new FunctionCommand([](){drive_sys.drive_tank(+roller_power, +roller_power);return false;}))->withTimeout(0.5),
      (new FunctionCommand([](){drive_sys.drive_tank(0, 0);return true;})),
  ...
  Vector2D::point_t shoot_point_other = {.x = 10.5, .y = 95};
  ...
  lss.add(TurnToPoint(endgame_point));        // [measure]
  lss.add(DriveToPointFastPt(endgame_point)); //[measure]
  lss.add(TurnToHeading(48));
  //// lss.add(PrintOdomContinous);
