...
ECHO    = @echo
DEFINES = -DVexV5  -D_GLIBCXX_USE_C99=1
...
CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -Os -Wall -Werror=return-type -Wno-unused-function -fno-rtti -fno-threadsafe-statics -fno-exceptions  -std=c++20 -ffunction-sections -fdata-sections -Wdocumentation $(DEFINES)
